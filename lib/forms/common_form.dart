...
import 'package:sulabh_market_app/components/bottom_nav_widget.dart';
import 'package:sulabh_market_app/components/image_picker_widget.dart';
                ...
                (categoryProvider.selectedSubCategory == 'Mobile Phones')
                    ? InkWell(
                        onTap: () =>
                            //brandBottomSheet(context, categoryProvider),
                            commonBottomsheet(
                                context, brandList, _brandController),
                        child: TextFormField(
