                                            ...
                                            child: ClipOval(
                                              child: Image.network(
                                                productProvider.sellerDetails![
                                                    'user_img'], // Replace this with the actual variable containing the user's image URL
                                                width: 74,
                                                height: 74,
                                                fit: BoxFit.cover,
                                              ),
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () {
                shareProductInfo(data['title'], data['description'],
                    productProvider.productData!.id);
              },
            ),
            if (firebaseUser.user!.uid != data['seller_uid'])
              IconButton(
                  onPressed: () {
                    setState(() {
                      isLiked = !isLiked;
