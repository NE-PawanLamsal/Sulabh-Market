...
class RecommendProductCard extends StatefulWidget {
  const RecommendProductCard({
    Key? key,
    required this.data,
    required this.formattedPrice,
    required this.numberFormat,
    required this.recommendSubcategory,
  }) : super(key: key);

  final QueryDocumentSnapshot<Object?> data;
  final String formattedPrice;
  final NumberFormat numberFormat;
  final String recommendSubcategory;

  @override
  State<RecommendProductCard> createState() => _RecommendProductCardState();
}

class _RecommendProductCardState extends State<RecommendProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.data['subcategory'] != widget.recommendSubcategory) {
      // If the product's subcategory is not the recommended one, return an empty container.
      return Container();
    }
